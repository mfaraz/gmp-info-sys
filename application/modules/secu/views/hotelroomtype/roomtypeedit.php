...
$set_id = (set_value('id') == '')?$roomtypedetails['id']:set_value('id');
$set_hid = (set_value('hid') == '')?$roomtypedetails['Hid']:set_value('hid');
...
$set_noofallotrooms = (set_value('noofallotrooms') == '')?$roomtypedetails['noofallotrooms']:set_value('noofallotrooms');
$set_fromdate = (set_value('fromdate') == '')?$roomtypedetails['fromdate']:set_value('fromdate');
$set_todate = (set_value('todate') == '')?$roomtypedetails['todate']:set_value('todate');
$set_lastupdated = (set_value('lastupdated') == '')?$roomtypedetails['lastupdated']:set_value('lastupdated');
$set_updateduser = (set_value('updateduser') == '')?$roomtypedetails['updateduser']:set_value('updateduser');
?>
<div class="form_content">
    <header><h3>Add  New Room type for Hotel:::<?php echo $hotelname;?></h3></header>
    <div class="module_content">
        <form name="roomform" id="roomform"  action="<?php echo base_url();?>secu/hotelroomtype/doeditroomtype" method="post" onsubmit="return validateForm()">
            <input type="hidden" name="id" id="id" value="<?php echo $set_id;?>">
             <input type="hidden" name="hid" id="id" value="<?php echo $set_hid;?>">
 ...
 <input type="text" name="noofallotrooms" id="noofallotrooms" value="<?php echo $set_noofallotrooms;?>" style="width:92%;">
             <?php echo form_error('noofbeds'); ?>
        </fieldset>
             <fieldset style="width:48%;">
            <label>Valid from</label>
 <input type="text" name="fromdate" id="fromdate" value="<?php echo $set_fromdate;?>" style="width:92%;">

        </fieldset>
              <fieldset style="width:48%;">
            <label>Valid Until</label>
 <input type="text" name="todate" id="todate" value="<?php echo $set_todate;?>" style="width:92%;">

        </fieldset>
                </fieldset>
              <fieldset style="width:48%;">
                  <label>Updated BY</label>
  <?php echo   $set_updateduser;?>  &nbsp; &nbsp;<?php echo   $set_lastupdated;?>
        ...
        <fieldset style="width:48%;">
           ...
           <fieldset style="width:48%;">
            <label>Children : Maximum Age Limit:  </label>
