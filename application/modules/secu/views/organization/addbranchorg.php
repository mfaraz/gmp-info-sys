<div class="form_content">
    <header><h3>Add Branch Organization Details</h3></header>
    <div class="module_content">
        <form name="organizationform" id="organizationform" method="post" action="<?php echo base_url(); ?>secu/organization/doaddbranchorg" onsubmit="return validateOrganizationForm()">
            <fieldset>
