...
<div class="form_content">
    ...
    <div class="module_content">
        <form name="hotelform" id="hotelform"  action="<?php echo base_url(); ?>secu/hotelcontent/savehotelcontent" method="post">
...
<div class="clear"></div>
      ...
      <form enctype="multipart/form-data" id="fupload" method="post" action="<?php echo base_url(); ?>secu/hotelcontent/savehotelimages">
          <input type="hidden" name="id" value="<?php echo $id;?> " id="id">
          <a name="img"></a>
...
<fieldset style="padding: 10px;">
 <?php foreach($imgdetails as  $img) { ?>
            ...
            <div class="imgbox">
                ...
                <div>
                    <a class="adel" href="<?php echo base_url()?>secu/hotelcontent/deletehotelimage/id/<?php echo $img["id"] ;?>/name/<?php echo $img["image"]; ?>/hid/<?php echo $img["hotelid"]; ?>">
