		...
		<div class="tab_container">
			...
			<tbody>
				...
				<tr>
                                ...
                                <td><?php foreach($hotel_lang as $lang_entry) : ?>
    				<?php echo $lang_entry['hotelname_uk']; ?>
                                <?php endforeach; ?></td>
                                <td><?php echo $hotel_entry['txtContactName']; ?></td>
                                <td><?php echo $hotel_entry['txtPhoneNo']; ?></td>
    				<td><?php echo $hotel_entry['numStars']; ?></td>    				
    				<td><a href="<?php echo base_url(); ?>admin/hotelcontent/?id=<?php echo $hotel_entry['id']; ?>"><img src="<?php echo base_url(); ?>images/admin/icn_new_article.png" title="add hotel content" /></a>&nbsp;<a href="<?php echo base_url(); ?>admin/edithotel/?hotel_id=<?php echo $hotel_entry['id']; ?>"><img src="<?php echo base_url(); ?>images/admin/icn_edit.png" title="edit hotel" /></a>&nbsp;<a href="javascript: void(0);" onclick="delHotel(<?php echo $hotel_entry['id']; ?>)"><img src="<?php echo base_url(); ?>images/admin/icn_trash.png" title="delete hotel"></a>&nbsp;<img src="<?php echo base_url(); ?>images/admin/icn_categories.png" title="add room types"></td>
				</tr>
