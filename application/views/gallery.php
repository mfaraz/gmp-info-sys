...
<div id="page-navi">
    <a href="#">Gampola</a> &rarr; <a href="#">Photo Gallery</a>
</div>
<!-- Page Navigation end-->
...
<ul class="about-navi">
    ...
    <div id="featured">
        <div><img src="<?php echo base_url(); ?>images/top-ban-04.png" width="690" class="left-align" style="margin-bottom:10px;" alt=""/>
            <h3>Nature</h3>
            <div id="gallery">
                <ul>
