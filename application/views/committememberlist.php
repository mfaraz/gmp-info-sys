...
<h2>Branch Organisation Committee Names</h2>
    ...
    <div class="news">
        ...
        <div class="section-02 st">
            ...
            <div id="defaultresult">
                <h5>Committee Members (City)</h5>
                <h6>Gampola - (Main Organization)</h6>
                <div class="table-style" style="position:relative; z-index:0;">
                    <table class="flexme1">
                        ...
                        <tbody>
                        <?php
                        foreach($orgdetailsmain_arr as $_data) :
                ...
                <h5>Committee Members (City)</h5>
                <h6>Gampola - (Youth Organization)</h6>
                <div class="table-style" style="position:relative; z-index:0;">
                    <table class="flexme1">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                        <?php
                        foreach($orgdetailsyouth_arr as $_data) :
                            $memid = $_data['memberid'];
                            $memname = $_data['membername'];
                            $memaddr = $_data['memberaddress'];
                            $memtel = $_data['membertelephone'];
                ...
                <h5>Committee Members (City)</h5>
                <h6>Gampola - (Women Organization)</h6>
                <div class="table-style" style="position:relative; z-index:0;">
                    <table class="flexme1">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                        <?php
                        foreach($orgdetailswomen_arr as $_data) :
                            $memid = $_data['memberid'];
                            $memname = $_data['membername'];
                            $memaddr = $_data['memberaddress'];
                            $memtel = $_data['membertelephone'];
