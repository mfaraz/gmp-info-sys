...
<div class="article">
    ...
    <div id="btm-navi">
        <a href="<?php echo base_url(); ?>religious/info/all">Religious Information</a> &rarr; <a href="<?php echo base_url(); ?>religious/info/temple">Buddhist Temple List</a> &rarr; <?php echo $detail_arr->orgname; ?>
