...
<div class="form_content">
    <header><h3>Post New Mealplan</h3></header>
    <div class="module_content">
        <form name="mealplanform" id="hotelform"  action="<?php echo base_url(); ?>secu/mealplan/doaddmealplan" method="post">
        <fieldset style="width:40%;">
            <label>Meal Plan Name</label>
            <input type="text" name="txtname" id="txtname" value="<?php echo $set_txttitle; ?>" style="width:92%;">
