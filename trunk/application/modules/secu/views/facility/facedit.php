<?php
$set_name = (set_value('name') == '')?$accdetails['Hfacility']:set_value('name');
$set_txtStatus = (set_value('txtStatus') == '')?$accdetails['status']:set_value('txtStatus');
?>
<div class="form_content">
    <header><h3>Edit Facility</h3></header>
    <div class="module_content">
        <form name="hotelform" id="hotelform"  action="<?php echo base_url(); ?>secu/facility/doeditfacility" method="post">
